...
package io.rushstreet.connect.jdbc.source;
...
public class JdbcSourceConnectorConfig extends AbstractConfig {
  ...
  public static final String SCHEMA_PREFIX_CONFIG = "schema.prefix";
  private static final String SCHEMA_PREFIX_DOC = "Schema prefix for tables in the whitelist.";
  private static final String SCHEMA_PREFIX_DISPLAY = "Schema prefix";
